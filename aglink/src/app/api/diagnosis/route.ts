...
async function getQuestionsFromSupabase(): Promise<QuestionMetadata[]> {
  const allQuestions: QuestionMetadata[] = [
    // Motivation (ID 1-5)
    {
      id: 1,
      question_text:
        "育てる野菜は、ちょっと形が変わった個性的な品種に魅力を感じる。",
      axis: "Motivation",
      pole: "A",
    },
    {
      id: 2,
      question_text:
        "農業を始める前に、費用対効果や収益の見込みを最初に計算したい。",
      axis: "Motivation",
      pole: "S",
    },
    {
      id: 3,
      question_text:
        "畑で一番やりがいを感じるのは、自分のアイデアやセンスが形になった時だ。",
      axis: "Motivation",
      pole: "A",
    },
    {
      id: 4,
      question_text:
        "農業の情報は、論理的でデータに基づいた客観的な情報を信頼する。",
      axis: "Motivation",
      pole: "S",
    },
    {
      id: 5,
      question_text:
        "育てた野菜は、味だけでなく、見た目の美しさやユニークさも大切にしたい。",
      axis: "Motivation",
      pole: "A",
    },
    ...
    // Scale (ID 6-10)
    {
      id: 6,
      question_text:
        "収穫した野菜は、自分で食べたり、おすそ分けして喜んでもらいたい。",
      axis: "Scale",
      pole: "F",
    },
    {
    ...
    },
    {
      id: 8,
      question_text:
        "家族や友人に「すごいね!」と褒めてもらうことが、大きなモチベーションになる。",
      axis: "Scale",
      pole: "F",
    },
    {
      id: 9,
      question_text:
        "農業に使うお金は、将来の独立も見据えてしっかり投資しても良いと考えている。",
      axis: "Scale",
      pole: "C",
    },
    {
      id: 10,
      question_text:
        "大きな畑を借りるチャンスがあったら、自分の事業として収益化を検討したい。",
      axis: "Scale",
      pole: "C",
    },
    ...
    },
    {
      id: 13,
      question_text:
        "農業の知識は、経験豊かな農家さんのもとで、お手伝いをしながら学ぶのが一番だと思う。",
      axis: "Approach",
      pole: "H",
    },
    {
      id: 14,
      question_text:
        "農業で困ったら、まずはAIやインターネットで原因や対策を調べたい。",
      axis: "Approach",
      pole: "I",
    },
    {
      id: 15,
      question_text:
        "農業は、新しい技術や知識を取り入れて、スマートに進めていきたい。",
      axis: "Approach",
      pole: "I",
    },
    ...
    // Stance (ID 16-20)
    {
      id: 16,
      question_text:
        "農業で失敗しても、「新しい発見があった」と前向きに捉えることができる。",
      axis: "Stance",
      pole: "O",
    },
    {
      id: 17,
      question_text: "育てた作物は、昔からある伝統品種のほうが安心感がある。",
      axis: "Stance",
      pole: "P",
    },
    {
      id: 18,
      question_text:
        "農業を通じて、IT企業やデザイナーなど異分野の人と繋がりたい。",
      axis: "Stance",
      pole: "O",
    },
    {
      id: 19,
      question_text:
        "計画通りに進まない時は、一度立ち止まり、計画を細かく見直してから次の行動を決めたい。",
      axis: "Stance",
      pole: "P",
    },
    {
      id: 20,
      question_text:
        "農業を始めた最終的な目標は、新しい価値を生み出し、可能性を広げることだ。",
      axis: "Stance",
      pole: "O",
    },
  ];
...
export async function POST(request: Request) {
  try {
    ...
    return NextResponse.json(
      {
        success: false,
        message: "分析に失敗しました。しばらく経ってから再度お試しください。",
      },
      { status: 500 }
    );
  }
